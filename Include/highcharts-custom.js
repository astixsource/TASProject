...
(function (q) {
    var u = q.Chart, A = q.addEvent, V = q.removeEvent, H = q.createElement, ea = q.discardElement, P = q.css, R = q.merge, M = q.each, E = q.extend, w = Math.max, L = document, W = window, l = q.isTouchDevice, N = q.Renderer.prototype.symbols, ba = q.getOptions(), Q; E(ba.lang, { printChart: "Print chart", downloadJPEG: "Download JPEG image", downloadPDF: "Download PDF document", contextButtonTitle: "Chart context menu" }); ba.navigation = { menuStyle: { border: "1px solid #A0A0A0",
        ...
        symbol: "menu", _titleKey: "contextButtonTitle", menuItems: [{ textKey: "printChart", onclick: function () { this.print() } }, { separator: !0 }, { textKey: "downloadJPEG", onclick: function () { this.exportChart({ type: "image/jpeg" }) } }, { textKey: "downloadPDF", onclick: function () { this.exportChart({ type: "application/pdf" }) } }]
    }
    }
