...
(function ($) {
    $.fn.freezeHeader = function (params) {
        ...
        if (params && params.height !== undefined) {
            divScroll = '<div id="hdScroll' + idObj + '" style="height: ' + params.height + '; overflow-y: auto; padding-right:8px;">';
            closeDivScroll = '</div>';
        }
        ...
        function cloneHeaderRow() {
            container.html('');
            container.val('');
            var tabela = $('<table style="margin:0; padding:0;"></table>');
            ...
            container.find('td').each(function (index) {
                var cellWidth = grid.find('td').eq(index).width();
