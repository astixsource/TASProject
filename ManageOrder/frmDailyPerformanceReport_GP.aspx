<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmDailyPerformanceReport_GP.aspx.cs" Inherits="frmDailyPerformanceReport" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#fraLeft').load(function () {
                ...
                $("#fraLeft").contents().find("#DvMenu").find("li[nid='48']").addClass("activemenu");
        ...
        function fnDownloadReport() {
            ...
            window.open("../frmDownloadExcel.aspx?flg=13&sDate=" + sDate + "&eDate=" + eDate);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRight" runat="Server">
    ...
    <div style="padding-top: 158px;" id="divtblContain"  >
