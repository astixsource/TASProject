<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmDownloadTASCallingReport.aspx.cs" Inherits="frmDownloadTASCallingReport" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#fraLeft').load(function () {
                ...
                $("#fraLeft").contents().find("#DvMenu").find("li[nid='45']").addClass("activemenu");
        ...
        function fnDownloadReport() {
            ...
            window.open("../frmDownloadExcel.aspx?flg=11");//&flgStatus=2&BranchCode=" + BranchCode + "&BranchNodeId=" + BranchNodeId + "&BranchNodeType=" + BranchNodeType + "&sDate=" + txtDate + "&IsMappingType=" + IsMappingType + "&flgType=" + flgType + "&LoginId=" + LoginId);
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRight" runat="Server" >
    ...
    <h4 id="h4header">>>Download TAS CALLING REPORT</h4>
    <div style="margin-top:5%;width:100%" class="text-center">
        <input type="button" value="Download TAS Calling Report" class="btn-lg btn-primary" onclick="fnDownloadReport()" />
    </div>
</asp:Content>
