<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmDownloadhistoryOrder.aspx.cs" Inherits="frmDownloadhistoryOrder" %>
    ...
    *top: 0.1em;
    ...
    <script>
        ...
        function fnDownloadOrder() {
                ...
                var LoginId = $("#cphRight_hdnLoginId").val();
                window.open("../frmDownloadExcel.aspx?flg=7&flgStatus=2&BranchCode=" + BranchCode + "&BranchNodeId=" + BranchNodeId + "&BranchNodeType=" + BranchNodeType + "&sDate=" + txtDate + "&IsMappingType=" + IsMappingType + "&flgType=" + flgType + "&LoginId=" + LoginId);
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRight" runat="Server" >
    ...
    <h4 id="h4header">>>Download History Order</h4>
    <div style="margin-top:10px;width:100%">
        <table id="tblhead" >
            ...
            <td>
                    ...
                    <td style="width: 90px">
                        <input type="text" id="txtDate" style="width: 72px" readonly /></td>
