<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmInit_Upload.aspx.cs" Inherits="SmartFileUpload_frmInit_Upload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRight" runat="Server">
    ...
    <div style="margin: 7px 80px; border: 1px solid #23aed8;" id="divMain">
        ...
        <em style="font-size:14px">Please upload excel document(.xlsx) format with file format(Filename_yyyyMMdd) i.e for 01-Jan-2020 file name should be<strong> "BranchMapping_20200101"</strong></em>                
    </div>   
        </div>
