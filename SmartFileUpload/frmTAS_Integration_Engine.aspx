<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTAS_Integration_Engine.aspx.cs" EnableSessionState="ReadOnly" Async="true" Inherits="frmTAS_Integration_Engine" %>
...
<body>
    ...
    <asp:FileUpload ID="fileUpload" onchange="fnChangeFileUpload()" runat="server" />
    </form>
</body>
</html>
