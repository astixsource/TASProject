	...
	function _fnFilterComplete ( oSettings, oInput, iForce )
	{
	  // debugger;
		...
		if ( _fnDataSource( oSettings ) != 'ssp' )
		{
			...
			//{
				_fnFilterColumn( oSettings, aoPrevSearch[0].sSearch, 0, fnRegex(aoPrevSearch[0]),
					aoPrevSearch[0].bSmart, aoPrevSearch[0].bCaseInsensitive );
			//}
		...
		var state = {
			...
			columns: $.map( settings.aoColumns, function ( col, i ) {
				return {
					...
					search: _fnSearchToCamel( settings.aoPreSearchCols[0] )
				};
			} )
		};
	...
	function _fnLoadState ( settings, oInit )
	{
		...
		for ( i=0, ien=state.columns.length ; i<ien ; i++ ) {
			...
			if ( col.search !== undefined ) {
				$.extend( settings.aoPreSearchCols[0], _fnSearchToHung( col.search ) );
			}
		}
