...
/// <summary>
/// Summary description for Exceldwn
/// </summary>
public class Exceldwn
{
    ...
    private static string getWorkbookTemplate()
    {
        ...
        sb.AppendFormat(@"   <Font ss:FontName=""Calibri"" x:Family=""Swiss"" ss:Size=""10"" ss:Color=""#ffffff""{0}", Environment.NewLine);
