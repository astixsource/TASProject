	...
	function validateTF(objectName,nullFlag,numericFlag,maxLenFlag,maxLenVal,emailFlag)
	{
		...
		if(maxLenFlag==1)
		{
			...
			{
				alert("Field Length Can't be greter than " + maxLenVal + " Character")
				eval(objectName).select()
				eval(objectName).focus()
				return false
			}
...
//alert(window.event.keyCode)
       if(window.event.keyCode==33 || window.event.keyCode==126 ||window.event.keyCode==35||window.event.keyCode==36 || window.event.keyCode==37 || window.event.keyCode==92 || window.event.keyCode==94 || window.event.keyCode==95 ||  window.event.keyCode==42 || window.event.keyCode==124 || window.event.keyCode==59 ||window.event.keyCode==60 || window.event.keyCode==62 || window.event.keyCode==63 || window.event.keyCode==39 || window.event.keyCode==43 || window.event.keyCode==45)
    {
        event.returnValue=false;
    } 
}
