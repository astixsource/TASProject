<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmBranchAttendance.aspx.cs" Inherits="ManageOrder_frmBranchAttendance" %>
    ...
    *top: 0.1em;
    ...
    <script>
        ...
        function fnStoreList() {
            ...
            PageMethods.fnBranchOrderStatusList(LoginId, BranchNodeId, BranchNodeType, SiteId,SiteTypeId,RouteDate,flgType, function (result) {
        ...
        function fnDownloadReport() {
            ...
            var SiteTypeId = Sitestr.split("-")[1];
            var flgType = $("#cphRight_hdnflg").val();
            window.open("../frmDownloadExcel.aspx?flg=4&BranchCode=" + BranchCode + "&DownloadDate=" + DownloadDate + "&BranchNodeId=" + BranchNodeId + "&BranchNodeType=" + BranchNodeType + "&SiteNodeId=" + SiteId + "&SiteNodeType=" + SiteTypeId + "&flgType=" + flgType);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRight" runat="Server" >
    ...
    <h4 id="h4header"><b id="lblHeader" runat="server">>> Branch Attendance Report</b></h4>
 ...
 <td style="width:60px"><b>Site List :</b> </td>
                ...
                <td style="padding-left:10px;padding-right:10px">
                    <asp:DropDownList runat="server" ID="ddlBranch" onchange="fnChangeBranch(this)" CssClass="form-control"  style="border:1px solid #bbbbbb;width:250px" >
                    </asp:DropDownList></td>
                <td style="padding-left:20px;">
                    <input type="button" value="Show Report" onclick="fnStoreList()" class="button" />
                    <input type="button" value="Download Report" onclick="fnDownloadReport()" class="button" />
                </td>
                 <td>
