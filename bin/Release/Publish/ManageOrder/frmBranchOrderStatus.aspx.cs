...
public partial class frmBranchOrderStatus : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["LoginID"] == null)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (flg == "2")
                {
                    lblHeader.InnerHtml = ">>SUBD Order Status List";
                    lblType.InnerHtml = "SUBD List :";
                }
                else
                {
                    lblHeader.InnerHtml = ">>Branch Order Status List";
        ...
        try
        {
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (tottc > 0)
                {
                    ...
                    str.Append("<table class='dataTable' id='tbldbrlist' style='width:100%' tottc='" + tottc + "'><thead><tr>");
                    ...
                    for (int j = 0; j < Ds.Tables[0].Columns.Count; j++)
                    {
                       ...
                       if (sColumnName == "DisplayText")
                        {
                            ss = "style='background-color:#26a6e7;color:#ffffff;vertical-align:middle;text-align:center;min-width:130px'";
                        }
                        else if (sColumnName == "Total" || sColumnName == "Downloaded")
                        {
                            ss = "style='background-color:#26a6e7;color:#ffffff;vertical-align:middle;text-align:center;min-width:100px'";
                        }
                        else
                        {
                            ss = "style='background-color:#008040;color:#ffffff;vertical-align:middle;text-align:center;font-size:7.5pt;min-width:80px'";
                        }
