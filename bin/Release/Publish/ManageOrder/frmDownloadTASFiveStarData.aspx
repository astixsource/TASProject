<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmDownloadTASFiveStarData.aspx.cs" Inherits="frmDownloadhistoryOrder" %>
    ...
    *top: 0.1em;
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var d = new Date();
            $("#txtFromDate").val(d.localeFormat('dd-MMM-yyyy'))
            ...
            $("#txtToDate").val(d.localeFormat('dd-MMM-yyyy'))
        ...
        function fnDownloadOrder() {
            ...
            var txtToDate = $("#txtToDate").val();
                ...
                window.open("../frmDownloadExcel.aspx?flg=17&FromDate=" + txtFromDate + "&&ToDate=" + txtToDate + "&LoginId=" + LoginId);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRight" runat="Server" >
    ...
    <h4 id="h4header">>>Download TAS Five Star Report</h4>
        ...
        <table id="tblhead" >
            ...
            <td>
                    ...
                    <td style="width: 110px">
                        <input type="text" id="txtFromDate" style="width: 90px" readonly /></td>

                 <td>
                        <b>To Date : </b>
                    </td>
                    <td style="width: 110px">
                        <input type="text" id="txtToDate" style="width: 90px" readonly /></td>
