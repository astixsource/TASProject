<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ManageOrder/MasterTelecaller.master" CodeFile="frmOrderPunching_PDA.aspx.cs" Inherits="frmOrderPunching_PDA" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
        ...
        $.widget('custom.mcautocompleteProductlist', $.ui.autocomplete, {
            ...
            _renderItem: function (table, item, cnt) {
                ...
                if (item.label == undefined) {
                    ...
                    var $tr = $("<tr FBID='" + FBID + "' flgFB='" + flgFB + "'  flgSBD1='" + flgSBD + "' sbdgroupid='" + sbdgroupid + "' flgInitiative='" + flgInitiative + "' RLP='" + RLP + "' MRP='" + MRP + "' SBF='" + SBF + "'  categoryid='" + Categoryid + "' SKUNodeID='" + SKUNodeID + "' UPC='" + UPC + "' SKUNodeType='" + SKUNodeType + "' Category='" + Category + "'>");
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fnSchemeDetailByStore() {
            ...
            $.ajax({
                url: "frmOrderPunching_PDA.aspx/fnSchemeDetailByStore",
                type: "POST",
        ...
        function fnGetLastOrders(storeid, TeleCallingId) {
            $.ajax({
                url: "frmOrderPunching_PDA.aspx/fnGetLastOrders",
                type: "POST",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function fnShowLastFiveOrders(arrData) {
            var strHML = "";
            var arr = ["PrdNodeId", "PrdNodeType", "PcsInBox", "Category", "CategoryId", "CategoryNetValue", "SBFNetValue", "OrderType", "SBDGroup", "CatNodeID", "SBDGroupId", "flgBaseProduct", "SBDPrdCnt", "UOM", "InvLevelDisc", "flgInitiative", "flgFB", "Brand", "brandNetValue", "FBName", "FBID", "IsFBProductShow", "flgSBD"];
            var d = new Date('<%=DateTime.Now%>');
            ...
            if (arrData.length > 0) {
                ...
                arrCatInvList = arrData[0].Table1;
                if (arrData[0].Table6.length > 0) {
                    ...
                    strname = strname.length > 20 ? strname.substr(0, 19) + ".." : strname;
                ...
                if (arrData[0].Table.length > 0) {
                    ...
                    for (var i in Table) {
                        ...
                        if (oldVal != Table[i]["CatNodeID"]) {
                            strHML += ("<tr flgdata='2' flgsbd='0' sbdgroupid='" + Table[i]["SBDGroupId"] + "' categoryid='" + Table[i]["CatNodeID"] + "' category='" + Table[i]["Category"] + "'>");
                            strHML += ("<td  colspan='8' style='" + style + ";background-color:#235889;font-weight:bold;color:#ffffff;padding:3px 5px;'>");
                            //strHML += "<a href='###' onclick='fnShowCatDetail(this)' style='color:blue;text-decoration: underline' title='Click to show last 5 invoice detail'>" + Table[i]["Category"] + "</a>";
                        ...
                        if ((parseInt(Table[i]["OrderType"]) == 1 || parseInt(Table[i]["OrderType"]) == 3) && flgBaseProduct == 1) {
                            TotSBD++;
                            strHML += ("<tr  UPC='" + UPC + "' flgsearch='1' flgInitiative='" + flgInitiative + "' FBID='" + FBID + "' flgSBD1='" + flgSBD + "' flgfb='" + flgfb + "'  oqty='" + Qty + "' flgbaseproduct='1' flgtrconsider='" + (Table[i]["SBDPrdCnt"] > 1 ? 0 : 1) + "'  flgsbd='" + ((parseInt(Table[i]["OrderType"]) == 1 || parseInt(Table[i]["OrderType"]) == 3) ? 1 : 0) + "' style='" + style + "'  flgdata='1' sbdgroupid='" + Table[i]["SBDGroupId"] + "' categoryid='" + Table[i]["CatNodeID"] + "' category='" + Table[i]["Category"] + "' skunodeid=" + Table[i]["PrdNodeId"] + " standardratebeforetax='" + standardratebeforetax + "' " + sbdgrouphightlight + "   mrp='" + MRP + "'  >");
                        } else {
                            strHML += ("<tr  UPC='" + UPC + "' flgdata='1' flgInitiative='" + flgInitiative + "' FBID='" + FBID + "' flgSBD1='" + flgSBD + "' flgfb='" + flgfb + "'  oqty='" + Qty + "' flgbaseproduct='0' flgtrconsider='" + (Table[i]["SBDPrdCnt"] > 1 ? 0 : 1) + "' flgsearch='1' flgsbd='" + ((parseInt(Table[i]["OrderType"]) == 1 || parseInt(Table[i]["OrderType"]) == 3) ? "1" : "0") + "' " + tdbgcolor + " style='" + (((parseInt(Table[i]["OrderType"]) == 1 || parseInt(Table[i]["OrderType"]) == 3) && flgBaseProduct == 0) ? "display:none" : "") + "' sbdgroupid='" + Table[i]["SBDGroupId"] + "' categoryid='" + Table[i]["CatNodeID"] + "' category='" + Table[i]["Category"] + "' skunodeid=" + Table[i]["PrdNodeId"] + " standardratebeforetax='" + standardratebeforetax + "'   mrp='" + MRP + "'  >");
                        }
                        ...
                        $.each(Table[i], function (key, value) {
                            if ($.inArray(key, arr) == -1) {
                                ...
                                if (key == "Product Name") {
                                    var strPromoimgage = "";
                                    if ((parseInt(Table[i]["OrderType"]) == 1 || parseInt(Table[i]["OrderType"]) == 3)) {
                                        strPromoimgage = " <img src='../btnImg/sbd_icon.png' style='width:4%;cursor:default' />";
                                    }

                                    if ((parseInt(flgfb) == 1)) {
                                        // value = IsFBProductShow == 1 ? "<a href='###' style='color:blue;text-decoration:underline' onclick='fnFilterFBSBF(this)'>" + value + "</a>" : value;
                                        strPromoimgage += "<img src='../btnImg/fb-icon.png' style='width:4%;margin-left:3px;cursor:default' />";
                                    }
                                    if (flgInitiative == 1) {
                                        strPromoimgage += "<img src='../btnImg/offers-icon.png' style='width:4%;margin-left:3px;cursor:default' />";
                                    }
                                    if ((parseInt(Table[i]["OrderType"]) == 1 || parseInt(Table[i]["OrderType"]) == 3) && flgBaseProduct == 1 && flgSBDChild > 1) {
                                        strHML += ("<td flgconsider='1' style='" + style + salign + "' Searchable='" + Searchable + "'><img src='../NewImages/icoAdd.gif' onclick='fnColapse(this)' >&nbsp;" + (value == null ? "" : value) + strPromoimgage + "</td>");
                                    } else {
                                        strHML += ("<td flgconsider='1'  style='" + style + salign + "' Searchable='" + Searchable + "'>" + (value == null ? "" : value) + strPromoimgage + "</td>");
                                    }
                                }
                                else if (key == "Order Qty") {
                                    if (flgBaseProduct == 1 && flgInactive == 1) {
                                        strHML += ("<td flgconsider='1'  style='" + style + salign + "'>NA</td>");
                                    } else {
                    ...
                    if (parseFloat(cntTotNetVal) > 0) {
                        ...
                        $("#anchorbtn2").find("div").css("width", "68px");
                    ...
                    $("#divSBDOrderedData").attr("gpvalue", arrSBDGrp.length);
                    $("#divSBDOrderedData").attr("TotSBD", TotSBD);
                    ...
                    for (i = 0; i < $("#tblPrdItemsMain tr[flgtrconsider=1]").eq(0).find("td[flgconsider=1]").length; i++) {
                        $("#tbl_Status_fixedhead").find("th").eq(i).css("width", $("#tblPrdItemsMain tr[flgtrconsider=1]").eq(0).find("td[flgconsider=1]")[i].offsetWidth);
                    ...
                    $("#dvtabcontainer").css("margin-top", $("#divHeader1").height());
                    //$("body").css("overflow-y", "scroll !important");
                    //dvtabcontainer
                    //divHeader1

                    var w1 = parseInt($("td.clsnet")[0].offsetWidth);

                    $("td.clsnet").css({
                        "width": w1,
                        "text-align": "center"
                    });
                    var w2 = parseInt($("td.clssku")[0].offsetWidth) + parseInt($("td.clssku")[1].offsetWidth) + parseInt($("td.clssku")[2].offsetWidth) + parseInt($("td.clssku")[3].offsetWidth);
                    $("td.clssku").eq(0).remove();
                    $("td.clssku").eq(1).remove();
                    $("td.clssku").eq(0).remove();
                    $("td.clssku").prop("colspan", "4");
                    $("td.clssku").css({
                        "width": w2,
                        "text-align": "center"
                    });

                    $("td.clssku").html("<div style='display:inline;width:36px;float:left'><img src='../images/AddNewProduct.png' style='width:50%' onclick='fnGetPrdList(this)' title='Click to add new product' /></div><div style='display:inline;float:right'># of Ordered SKU's:</div>");
                    $("td.clsnet").html("Total:");
                    // $("#txtsearchPrd").val("Search New Products");
                    // $("#txtsearchPrd").focus();
                    if ($("#tblPrdItemsMain tbody").find("input[type='text']").length > 0) {
                        $("#tblPrdItemsMain tbody").find("input[type='text']").eq(0).focus();
                    }
                ...
                //strHML += ("<table cellpadding='2' cellspacing='0' style='border-right: 1px solid #A0A0A0; border-top: 1px solid #A0A0A0;text-align:center;width:100%'>");
                //strHML += ("<tr bgcolor='#26a6e7'><td style='" + style + ";color:#fff;padding:2px'>Inv.No</td><td style='" + style + ";color:#fff;padding:2px'>Inv.Date</td><td style='" + style + ";color:#fff;padding:2px'>Inv Val</td></tr>");
                ...
                //    strHML += ("<tr " + bgcolr + "   OrderStatusID=2 OrdPrcsId=2><td style='" + style + ";text-align:left;;padding:2px;padding-left:5px'>" + arrData[0].Table1[i]["InvNo"] + "</td><td style='" + style + ";padding:2px'>" + arrData[0].Table1[i]["Inv Date"] + "</td><td style='" + style + ";padding:2px;padding-right:5px' align='right'>" + arrData[0].Table1[i]["NetValue"] + "</td></tr>");
                //}
                //strHML += "</table>";
                //$("#divOrderlstbasedOnstore")[0].innerHTML = strHML;
                ...
                for (var i in arrData[0].Table2) {
                    ...
                    strHTML1 += "<tr><td style='padding:1px 0px 1px 10px;text-align:left'><label style='color:#5b6367'><input type='radio' name='rdoCnted' value=" + arrData[0].Table2[i].ReasonCodeID + ">" + arrData[0].Table2[i].REASNCODE_LVL2NAME + "</label></td><tr>";
                }
                for (var i in arrData[0].Table3) {
                    strHTMLHeader2 = arrData[0].Table3[i].REASNCODE_LVL1NAME;
                    if (arrData[0].Table3[i].flgSchedule == 1) {
                        strHTML2 += "<tr><td style='padding:1px 0px 1px 10px;text-align:left'><label style='color:#5b6367'><input type='radio' name='rdoCnted' flgSchedule=" + arrData[0].Table3[i].flgSchedule + " value=" + arrData[0].Table3[i].ReasonCodeID + ">" + arrData[0].Table3[i].REASNCODE_LVL2NAME + "</label>&nbsp; &nbsp;    <i>Schedule Time :</i><select id='ddlschedulecall'></select></td></tr>";
                    } else {
                        strHTML2 += "<tr><td style='padding:1px 0px 1px 10px;text-align:left'><label style='color:#5b6367'><input type='radio' name='rdoCnted' flgSchedule=" + arrData[0].Table3[i].flgSchedule + " value=" + arrData[0].Table3[i].ReasonCodeID + ">" + arrData[0].Table3[i].REASNCODE_LVL2NAME + "</label></td></tr>";
                    }

                }
                $("#dvReason")[0].innerHTML = "<div><table style='width:100%;font-size:8pt' class='table-bordered table-condensed'><tr><td style='text-align:left;padding:4px 0px 4px 6px;background-color:#8080ff;color:#ffffff'><b>" + strHTMLHeader1 + "</b></td></tr>" + strHTML1 + "<tr><td style='text-align:left;padding:4px 0px 4px 6px;background-color:#8080ff;color:#ffffff'><b>" + strHTMLHeader2 + "</b></td></tr>" + strHTML2 + "</table></div>";
        ...
        function fnFillOrder(cntrlTR, flg, e) {
            ...
            $("#tblPrdItemsMain tbody").find("tr[flgdata=1][categoryid='" + IntCategoryId + "']").eq(trs.length - 1).find("input").eq(0).focus();
        ...
        function fnAddNewProductsHTML(cntrl) {
            ...
            var flgSBD = $(cntrl).attr("flgSBD1");
            var sbdgroupid = $(cntrl).attr("sbdgroupid");

            var strHML = ("<tr flgdata='1' FBID='" + FBID + "' flgFB='" + flgFB + "'  flgSBD1='" + flgSBD + "' sbdgroupid='" + sbdgroupid + "' oqty='0'  flgInitiative='" + flgInitiative + "'  flgbaseproduct='0' category='" + Category + "' categoryid='" + CategoryId + "' flgsbd='0' skunodeid=" + SKUNodeID + " standardratebeforetax='" + rlp + "' mrp='" + mrp + "' bgcolor='#ffffc4'>");
            ...
            strHML += ("<td flgconsider='1'  style='" + style + ";text-align:right;padding-right:2px;' invdiscountamount='0.00' DiscountAmount='0.00' iden='disc'>0.00</td>");
                    ...
                    buttons: {
                        "Submit": function () {
                            ...
                            try {
                                ...
                                $("#dvFadeForProcessing").css("display", "block");
                                PageMethods.fnspPopulateOrderDetail(OrderMaster, OrderDetail,arrStoreProductAppliedSchemesBenifitsRecords, flgProductive, TeleCallID, ReasonId, ScheduleCall, $("#cphRight_hdnSalesNodeId").val(), $("#cphRight_hdnSalesNodeType").val(), $("#cphRight_hdnLoginId").val(), function (result) {
                                    $("#dvFadeForProcessing").css("display", "none");
                                    if (result.split("^")[1] == 4) {
        ...
        function fnShowSlabAchievementDetail(sender, schmeId, SlbId) {
            ...
            $("#dvSchemeDescr").dialog({
                ...
                open: function () {
                    setTimeout(function () {
                        var strHTML = "<table style='font-size:8.8pt' class='table table-bordered table-condensed' cellpadding='2' cellspacing='0'>";
                        var style = "";
                        ...
                        if (SchemeCode.indexOf("LSS") == 0) {
                            ...
                            strHTML += "<table id='tblSchemeCalculationSKUs1' style='font-size:8pt;' class='table table-bordered table-condensed' cellpadding='2' cellspacing='0'>";
                            ...
                            for (var cntSubBucket in arrSubBucketDetails) {
                                ...
                                if (arrProductIDMappedInSchSlbSub.length > 0) {
                                    ...
                                    for (var i in arrProductIDMappedInSchSlbSub) {
                                        ...
                                        var IsLink = 0;
                                        var flgInitiative = 0;
                                        var style1 = "background-color:#235889;color:#fff";
                                        if ($("#tblPrdItemsMain tr[flgdata=1][skunodeid=" + ProductID + "]").length > 0) {
        ...
        function fnProductLineInitiative(sender) {
            var TotDiscountValue =$("#tdLineSchemeDiscount").html();
                    ...
                    for (var i = 0; i < trPrdItemsMain.length; i++) {
                        ...
                        if (parseFloat(DiscVal) > 0) {
                            ...
                            for (var discnt in SchemeProduct) {
                                ...
                                strHTML += "<td style='text-align:right;padding:2px 3px;'>&#8377; " + parseFloat(distval).toFixed(2) + "</td>";
        ...
        function fnShowStoreInitiative() {
            ...
            $("#dvSchemeDescr").dialog({
                ...
                open: function () {
                    var strHTML = "<table id='tblSchemeCalculationSKUs1' style='font-size:8pt;' border='1' rules='all' class='table table-bordered table-condensed' cellpadding='2' cellspacing='0'>";
                    strHTML += ("<thead><tr class='success'>");
                ...
                open: function () {
                    PageMethods.fnGetSchemeMasterPopupDetail(schmeId, function (result) {
                        if (result.split("|")[0] == "2") {
                            ...
                            var strHTML = "<table style='font-size:8.5pt' class='table table-bordered table-condensed' cellpadding='2' cellspacing='0'>";
                            var style = "";
                            var flgSchemeSlabDescrAgainStore = jQuery.grep(SchemeDetailByStore[0].Table1, function (element, index) {
                                return (parseInt(element.SchemeID) == parseInt(schmeId));
                            });
            ...
            for (var i = 0; i < trPrdItemsMain.length; i++) {
                ...
                if ($.inArray(skunodeid, arrSKUCheck) == -1) {
                    ...
                    if (flgFB == 1) {
                        ...
                        $("#tblFocusBrandMain tr[fbid='" + FBID + "']").find("td").eq(2).html(fbGap);
    ...
    <script type="text/javascript" language="javascript">
        ...
        function fnSaveOrderData(flg, OrderDetail) {
            ...
            var GPValue = $("#divSBDOrderedData").attr("gpvalue");
            var SBDTotalGap = $("#divSBDOrderedData").is("[TotSBD]") ? $("#divSBDOrderedData").attr("TotSBD") : 0;
            var trFBs = $("#tblFocusBrandMain tbody tr");
            ...
            arrayRowData = [{
                ...
                CustomerPODate: CustomerPODate, Remarks: Remarks, NetOrderValue: NetOrderValue, OrderStatusId: OrderStatusId, flgOrderClosed: flgOrderClosed, SalesPersonId: SalesPersonId
            , SalesPersonNodeType: SalesPersonNodeType, OrderSourceID: OrderSourceID, flgOffline: flgOffline, OrdPrcsId: OrdPrcsId, ReasonId: ReasonId, ReasonText: ReasonText, DeliveryDate: DeliveryDate,
            TotOrderVal: TotOrderVal, TotMRPValue: TotMRPValue, TotLineLevelDisc: TotLineLevelDisc, TotDiscVal: TotDiscVal, GPValue: GPValue, FocBndAlrAch: FocBndAlrAch, FocBndNowAch: FocBndNowAch, FocBndSBFOrd: FocBndSBFOrd, FocBndSBFQtyOrd: FocBndSBFQtyOrd,
            FocBndSBFValueOrd: FocBndSBFValueOrd, SBDSBFOrd: SBDSBFOrd, SBDTotalGap: SBDTotalGap
            }];
        ...
        function fnSaveFinalData(flg) {
            ...
            for (var i = 0; i < trPrdItemsMain.length; i++) {
                ...
                var MRP = $(trPrdItemsMain[i]).attr("mrp");
                ...
                var flgSBDGap = $(trPrdItemsMain[i]).attr("flgsbd");
                ...
                var flgsbd = $(trPrdItemsMain[i]).attr("flgsbd1");
                ...
                if (parseInt(OrderQty) > 0) {
                    ...
                    strHTML += "<td style='text-align:right;padding-right:2px'>" + parseFloat(MRP).toFixed(2) + "</td>";
            ...
            strHTML1 += "<td align='center'>MRP<br/>(&#8377;)</td>";
    ...
    <script>
        ...
        function fnGobackpage() {
            var sconfirm = confirm("Are you sure to go back?");
            if (sconfirm) {
                window.location.href = "frmRouteList_PDA.aspx";
            }
        }
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphRight" runat="Server">
    ...
    <div style="width:100%">
        ...
        <div class="form-group">
            ...
            <label for="" id="tdSector" style="margin-left:8px"></label>
        </div>
        
                     <%--<div class="form-group">
            <label for="">CallType:</label>
            <label for="" id="tdCallType"></label>
        </div>--%>
                     <%--<div class="form-group">
            <label for="">Scheduled DT:</label>
            <label for="" id="tdScheduledDT">afadfa</label>
        </div>--%>
    </div>
                <div class="form-inline" id="tblhead1" style="margin-top: 2px;margin-left: 2px;">
        <div class="form-group">
            <label for="">Contact No:</label>
            <label for="" id="tdContactNo"></label>
        </div>
         <div class="form-group">
            ...
            <label for="" id="tdStoreChannel"></label>
              <a style="float:right;text-decoration:underline;color:blue" href="###" onclick="fnShowStoreInitiative()">
                     ...
                     <div class="form-group">
            <label for="">SBD Ordered Details:</label>
            <label for="" id="divSBDOrderedData"></label>
               ...
               <div class="form-group">
                  <div id="divSchemeAppliedSectionAchievement" style="border:1px solid #486066;overflow-y: auto; overflow-x: hidden; height: 90px; padding: 1px;">
            ...
            <div style="margin-left: 0px; display: block; width: 100%;margin-bottom:66px;margin-top:2px;" id="dvtabcontainer">
                ...
                <div id="divFixedFooter" style="padding-bottom:5px;padding-top:5px;margin-left: 0px; bottom: 34px; position:fixed;z-index:1;background-color:#408080;color:#ffffff"></div>           
        ...
        <div style="display:none;margin-top: 10px; width: 100%; margin-left: 2px;" flg="1"" id="divRightContainer">
             ...
             <div style="display:none;margin-top: 10px;width: 100%;  border: 1px solid #A0A0A0; font-size: 7.5pt">
                <div style="margin-top: -6px; margin-left: 30%; width: 42%; background-color: #ffffff;font-weight:bold;font-size:8pt">
                    <center><b>Outstanding &nbsp;Details</b></center>
                </div>
                <div id="divOutstandingData" style="overflow-y: auto; overflow-x: hidden; height: 38px; padding: 5px;"></div>
            </div>
    ...
    <div class="blockButtons" style="z-index:10;width: 100%; bottom: 0; position: fixed; padding-top: 1px; background-color: #cfcfcf;">
        <table style="width:100%">
            <tr>
                ...
                <td>
                    <img src="../images/arrow-back-icon.png"  title="Click To Go Back" onclick="fnGobackpage()" />
                </td>
                <td>
                    <img src="../images/legendsicon.png" title="Click To Show Legends" onclick="fnShowLegends()" />
                </td>
     ...
     <div id="divFocusBrandData" style="display:none">
                    <table class="table-small table-bordered" id="tblFocusBrandMain" style="font-size:7.5pt;display:none" cellspacing="0" cellpadding="0">
                    <thead>
                      <tr>
    ...
    <div style="display: none; text-align: center;" class="table-responsive" id="dvSchemeDescr" title="Schemes Description">
    </div>
