<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="frmRptLeapFileUploadingStatus.aspx.cs" Inherits="frmRptLeapFileUploadingStatus" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#fraLeft').load(function () {
                ...
                $("#fraLeft").contents().find("#DvMenu").find("li[nid='40']").addClass("activemenu");
        ...
        function fnShowReport(flgExcel) {
            ...
            PageMethods.fnDailyOrderStatusReport(LoginId, sDate, eDate, NodeId, NodeType, flgExcel, function (result) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphRight" runat="Server">
    ...
    <div style="margin-left: 0px; padding-bottom: 10px; position: fixed; z-index: 1; width: 96%; background-color: #ffffff" id="divHeadercont">
        <h4 id="h4header" style="font-size: 12px">>>Daily Leap File Uploading Status</h4>
            ...
            <div class="row" id="divFilter">
                ...
                <div class="col-md-2">
                    <table style="display: inline-block">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ddlSite" AutoPostBack="false" onchange="fnChangeSite(this)" Style="border: 1px solid #bbbbbb; width: 134px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="col-md-3">
                    <div class="text-center" id="divbtn" style="padding-top: 2px; float: left;">
                        <input type="button" class="btn btn-primary" style="padding: 3px 4px; font-size: 12px" value="Show" onclick="fnShowReport(0)" />
                        <asp:Button runat="server" Text="Download All Sites" class="btn btn-primary" Style="padding: 3px 4px; font-size: 12px" ID="btnDownloadAll" OnClientClick="fnSetDateInHiddenField()" OnClick="btnDownloadAll_Click" />
                        <asp:Button runat="server" Text="Download" class="btn btn-primary" Style="padding: 3px 4px; font-size: 12px" ID="btnRefershStatus" OnClientClick="fnSetDateInHiddenFieldSite()" OnClick="btnRefershStatus_Click" />
                    </div>
                </div>
            </div>
        </div>
