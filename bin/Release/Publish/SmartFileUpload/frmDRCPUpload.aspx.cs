...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs args)
    {
        ...
        if (!this.IsPostBack)
        {
            ...
            tdHeader.InnerHtml = ">> Upload Swing DRCP";
    ...
    private void fnBindBranchList()
    {
        ...
        try
        {
            ...
            Scmd.CommandText = "spGetBranchListForSwingDRCPUpload";
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
                ...
                SkipColumn[4] = "IsMappedLeapSwing";
                ...
                for (int j = 0; j < Ds.Tables[0].Columns.Count; j++)
                {
                    ...
                    else if(sColumnName== "Last Updated")
                    {
                        ss = "style='text-align:center;width:11.5%'";
                    }
                    str.Append("<th " + ss + ">" + sColumnName.Split('^')[0] + "</th>");
                }
                str.Append("<th style='text-align:center;width:9%'>Route Mapping</th>");
                ...
                str.Append("<th style='text-align:center;width:45%' colspan='2'>Upload Status</th>");
                ...
                for (int i = 0; i < Ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    str.Append("<tr brnnodeid='" + Ds.Tables[0].Rows[i]["brnnodeid"].ToString() + "' brnnodetype='" + Ds.Tables[0].Rows[i]["brnnodetype"].ToString() + "'  >");//MappingTypeId='" + Ds.Tables[0].Rows[i]["MappingTypeId"].ToString() + "'
                    ...
                    for (int j = 0; j < Ds.Tables[0].Columns.Count; j++)
                    {
                        ...
                        {
                            str.Append("<td style='text-align:center' iden='clslastupd'>" + sData + "</td>");
                        }
                        else {
                            str.Append("<td " + ss + "   " + flgSearchable + ">" + sData + "</td>");
                        }
                    }
                    str.Append("<td style='text-align:center' iden='clslastrn'><a href='###' onclick='fnUpdateRouteNo(this)' style='font-size:9pt;color:blue;text-decoration:underline' >Route Mapping</a></td>");
                    ...
                    str.Append("<td style='text-align:center' iden='tdfile'><input type='file' flgUpload='0' class='clsfile' id='sfile" + brnnodeid + "' name='sfile" + brnnodeid + "' accept='application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'  /></td>");
                    str.Append("<td style='text-align:left;width:27%' iden='clsstatus'></td>");
                    str.Append("</tr>");
                }
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < Ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (cnt == 0)
                    {
                        ...
                        str.Append("<td style='" + ss + ";text-align:center;background-color:#26a6e7;color:#ffffff'>Mon Route No</td>");
                        str.Append("<td style='" + ss + ";text-align:center;background-color:#26a6e7;color:#ffffff'>Sat/Sun Route No</td>");
                        str.Append("</tr>");
                    }
