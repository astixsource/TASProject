...
public partial class SmartFileUpload_frmTAS_Integration : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs args)
    {
        ...
        if (!this.IsPostBack)
        {
            ...
            {
                hdnMnId.Value = "17";
                hdnFileName.Value = "AR.xlsx";
                tdFilelbl.InnerHtml = "File Upload For :  " + hdnFileName.Value.Split('.')[0];
            }
            else if (FileSetType == "4")
            {
                hdnMnId.Value = "18";
                hdnFileName.Value = "PSR.csv";
                tdFilelbl.InnerHtml = "File Upload For :  " + hdnFileName.Value.Split('.')[0];
            }                     
            else if (FileSetType == "5")
            {
                hdnMnId.Value = "20";
                hdnFileName.Value = "DRCP.csv";
                tdFilelbl.InnerHtml = "File Upload For :  " + hdnFileName.Value.Split('.')[0];
            }
            tdNamecon1.InnerHtml = "<b style=\"font-size: 10pt;\">Sample File : </b><a title='Click to download sample file' target='_blank' style=\"font-size: 10pt;color:blue;text-decoration:underline\" href='SampleFile/" + hdnFileName.Value.Split('.')[0] + "_yyyyMMdd.xlsx'>" + hdnFileName.Value.Split('.')[0] + "_yyyyMMdd.xlsx</a>";
    ...
    public void downloadtransaction()
    {
        ...
        {
            Scmd.CommandText = "[spGetDRCPExceptionDetail]";
        }
